    ...
    <ul class="pl-10 mt-2 space-y-2">
        <li>
            <a href="{{ route('categories.index') }}" class="nav-sublink">All Categories</a>
        </li>
        <li>
            <a href="{{ route('categories.create') }}" class="nav-sublink">Add New</a>
        </li>
    </ul>
</li>
            <a href="#" class="nav-link">
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open" class="nav-link flex items-center w-full transition-all duration-300"
                    :class="open ? 'nav-link-active' : ''">
                    <i data-lucide="users" class="w-5 h-5 flex-shrink-0"></i>
                    <span class="nav-text ml-3 flex-1 text-left">Authors Management</span>
                    <i data-lucide="chevron-down" class="w-4 h-4 transition-transform duration-300 flex-shrink-0"
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    <div
                        class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-accent-color to-info opacity-80">
                    </div>
                    ...
                    <a href="{{ url('/request-author') }}"
                        ...
                        <div
                            class="w-8 h-8 rounded-lg bg-warning/20 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                        ...
                        <i data-lucide="arrow-right"
                            class="w-4 h-4 text-muted group-hover:text-accent-color group-hover:translate-x-1 transition-all"></i>
                    </a>
                    ...
                    <a href="{{ url('/requested-authors') }}"
                        class="flex items-center px-4 py-3 text-sm transition-all duration-200 group relative hover:bg-bg-tertiary/50 mx-2 rounded-lg">
                        <div
                            class="w-8 h-8 rounded-lg bg-info/20 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                    ...
                    <a href="{{ url('/authors') }}"
                        class="flex items-center px-4 py-3 text-sm transition-all duration-200 group relative hover:bg-bg-tertiary/50 mx-2 rounded-lg">
                        <div
                            class="w-8 h-8 rounded-lg bg-success/20 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                    ...
                    <div
                        class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-accent-color via-info to-success opacity-60">
                    </div>
                </div>
            </div>
